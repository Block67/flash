...
<header>
    ...
    <div class="mx-auto max-w-screen-md py-8 px-4 sm:px-6 lg:px-8 flex flex-col items-center sm:flex-row justify-between">
        <div class="w-full sm:w-1/2 mx-auto px-2 sm:px-0">
            <h6 class="text-2xl font-semibold text-gray-900 dark:text-white text-center sm:text-left">WELCOME BACK!</h6>
            <p class="text-gray-700 dark:text-gray-300 text-center sm:text-left mb-6">Connect and send money anywhere with <span style="color: #ff7c2a;">₿itcoin</span></p>
        </div>
        <div class="w-full sm:w-1/2 mx-auto px-2 sm:px-0">
            <div class="bg-white shadow-md rounded-lg px-8 py-6">
                <form method="post" action="login_endpoint.php">
                    ...
                    <input class="w-full px-8 py-2 rounded-lg font-medium bg-orange-500 text-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-orange-400 hover:bg-orange-600 transition-all duration-300 ease-in-out custom-button-color" type="submit" value="Connexion" name="login" />
