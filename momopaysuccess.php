    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
            <div class="text-center flex justify-center">
                <div>
                    <img src="img/Frame 25.svg" alt="Description de l'image" class="w-200 h-150 object-cover mx-4" />
                </div>

            </div>
        </div>
        <div class="text-center">
            <p class="my-4 text-lg text-gray-800 dark:text-gray-200">Payment successful</p>
        </div>
        </br></br>
